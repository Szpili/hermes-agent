...
| `HERMES_CODEX_BASE_URL` | Override the OpenAI Codex backend URL. Defaults to `https://chatgpt.com/backend-api/codex`; `CODEX_BRIDGE_URL` remains supported as a legacy fallback |
